                    ...
                    <Row className={"d-flex flex-row flex-lg-row-reverse px-0"}>
                        ...
                        <Col className={"p-3"} sm={12} lg={6}>
                            ...
                            <Container className={"d-flex justify-content-center my-4 py-4"}>
                                <Link onClick={handleLink} to={"/volunteer"} className={"btn btn-outline-info"}>Volunteer with us today!</Link>
                            </Container>
                        </Col>
                    </Row>
                </Container>
                        ...
                        <Row className={"d-flex flex-row"}>
                            ...
                            <Col className={"p-3"} sm={12} lg={6} fluid>
                                ...
                                <Container className={"d-flex justify-content-center my-5"}>
                                    <Link onClick={handleLink} to={"/volunteer"} className={"btn btn-outline-info"}>
                    ...
                    <Container className={"px-0"} fluid>
                        <Row className={"d-flex flex-row"}>
                            ...
                            <Col className={"py-3 px-4"} sm={12} lg={6} fluid>
                                <Container className={"px-0"} fluid>
                                    <h2 className={"fw-light text-lg-start"}><span className={"border-decor"}>Cook Volunteer Duties:</span></h2>
                                    <ol className={"lead fs-4 "} style={{"textAlign": "justify"}}>
                            ...
                            <Col className={"py-3 px-4 fs-4"} sm={12} lg={6} fluid>
                                <Container className={"px-0"} fluid>
                                    <h2 className={"fw-light text-lg-end"}><span className={"border-decor"}>Please Note:</span></h2>
